    ...
    <form class="form-horizontal" action="{{ url('/update-user/'.$user->id) }}" method="POST"
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <!-- แสดงข้อมูลเดิมที่มีอยู่ของชื่อ และแก้ไขได้  -->
                    <!-- 65160240 นายอภิภัสร์ ทศพร -->
            ...
            <div class="form-group row">
                <!-- แสดงข้อมูลเดิมที่มีอยู่ของ email และแก้ไขได้  -->
                <!-- 65160240 นายอภิภัสร์ ทศพร -->
            ...
            <div class="form-group row">
                <!-- แสดงข้อมูลเดิมที่มีอยู่ของรูปภาพ และแก้ไขได้  -->
                <!-- 65160240 นายอภิภัสร์ ทศพร -->
